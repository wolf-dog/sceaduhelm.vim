...
hi MatchParen   ctermfg=88      ctermbg=none    cterm=bold      guifg=#870000   guibg=NONE      gui=bold
...
hi DiffDelete   ctermfg=234     ctermbg=130     cterm=none      guifg=#1c1c1c   guibg=#af5f00   gui=none
...
hi Number       ctermfg=166     ctermbg=none    cterm=bold      guifg=#df5f00   guibg=NONE      gui=bold
hi Identifier   ctermfg=229     ctermbg=none    cterm=bold      guifg=#ffffaf   guibg=NONE      gui=bold
...
hi Keyword      ctermfg=115     ctermbg=none    cterm=bold      guifg=#87dfaf   guibg=NONE      gui=bold
hi PreProc      ctermfg=221     ctermbg=none    cterm=bold      guifg=#ffdf5f   guibg=NONE      gui=bold
hi Type         ctermfg=166     ctermbg=none    cterm=none      guifg=#df5f00   guibg=NONE      gui=none
